...
if(file.exists('renv')) renv::activate()
```
...
# Install devtools to install specific version of a package.
check_install_load('devtools',repo='cran',load=F)

# Install Bioconductor.
check_install_load('BiocManager',repo='cran',load=F)
bioc='3.11'
install_steps=T
if(BiocManager::version()!=bioc){
  BiocManager::install(version=bioc,update=T,ask=F)
  install_steps=c(F,T)
}
```
...
for(i in install_steps){
  ...
  check_install_load('tidyverse','1.3.1',repo='bioc',bioc=bioc,load=i)
  check_install_load('dslabs','0.7.4',repo='bioc',bioc=bioc,load=i)
  check_install_load('GEOquery','2.56.0',repo='bioc',bioc=bioc,load=i)
  check_install_load('Biobase','2.48.0',repo='bioc',bioc=bioc,load=i)
  check_install_load('a4Base','1.36.0',repo='bioc',bioc=bioc,load=F)
  check_install_load('biomaRt','2.44.4',repo='bioc',bioc=bioc,load=i)
  check_install_load('oligo','1.52.1',repo='bioc',bioc=bioc,load=i)
  check_install_load('RSQLite','2.2.12',repo='bioc',bioc=bioc,load=i)
  check_install_load('DBI','1.1.2',repo='bioc',bioc=bioc,load=i)
  check_install_load('Rcpp','1.0.7',repo='bioc',bioc=bioc,load=i)
  check_install_load('pd.hugene.1.0.st.v1','3.14.1',repo='bioc',bioc=bioc,load=i)
  check_install_load('pd.hta.2.0','3.12.2',repo='bioc',bioc=bioc,load=i)
  check_install_load('pd.clariom.s.human','3.14.1',repo='bioc',bioc=bioc,load=i)
  check_install_load('limma','3.44.3',repo='bioc',bioc=bioc,load=i)
  check_install_load('illuminaio','0.30.0',repo='bioc',bioc=bioc,load=i)
  check_install_load('parallelDist','0.2.6',repo='bioc',bioc=bioc,load=i)
  check_install_load('WGCNA','1.70.3',repo='bioc',bioc=bioc,load=i)
  check_install_load('sva','3.36.0',repo='bioc',bioc=bioc,load=i)
  check_install_load('pbapply','1.5.0',repo='bioc',bioc=bioc,load=i)
  check_install_load('lubridate','1.8.0',repo='bioc',bioc=bioc,load=i)
  check_install_load('rsdr','0.1.0',repo='herdiantrisufriyana',load=i)
  check_install_load('caret','6.0.92',repo='bioc',bioc=bioc,load=i)
  check_install_load('glmnet','4.1.4',repo='bioc',bioc=bioc,load=i)
  check_install_load('Rborist','0.2.3',repo='bioc',bioc=bioc,load=i)
  check_install_load('gbm','2.1.8',repo='bioc',bioc=bioc,load=i)
  check_install_load('gam','1.20.1',repo='bioc',bioc=bioc,load=i)
  check_install_load('MLeval','0.3',repo='bioc',bioc=bioc,load=i)
  check_install_load('doParallel','1.0.17',repo='bioc',bioc=bioc,load=i)
  check_install_load('preprocessCore','1.50.0',repo='bioc',bioc=bioc,load=i)
  check_install_load('matrixStats','0.61.0',repo='bioc',bioc=bioc,load=i)
  check_install_load('Rtsne','0.16',repo='bioc',bioc=bioc,load=i)
  ...
  check_install_load('igraph','1.3.0',repo='bioc',bioc=bioc,load=i)
  check_install_load('reticulate','1.24',repo='bioc',bioc=bioc,load=i)
  check_install_load('tensorflow','2.0.0',repo='devtools',load=F)
  check_install_load('keras','2.3.0.0',repo='devtools',load=F)
  check_install_load('ggnetwork','0.5.10',repo='bioc',bioc=bioc,load=i)
  # check_install_load('STRINGdb','2.0.2',repo='bioc',bioc=bioc,load=i)
  # check_install_load('ReactomePA','1.32.0',repo='bioc',bioc=bioc,load=i)
  # check_install_load('org.Hs.eg.db','3.11.4',repo='bioc',bioc=bioc,load=i)
  check_install_load('rpart.plot','3.1.0',repo='bioc',bioc=bioc,load=i)
  check_install_load('knitr','1.37',repo='bioc',bioc=bioc,load=i)
  check_install_load('kableExtra','1.3.4',repo='bioc',bioc=bioc,load=i)
