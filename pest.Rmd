---
title: 'Blood biomarkers representing maternal-fetal interface tissues for 
        predicting early-and late-onset preeclampsia but not COVID-19 infection'
author:
...
check_install_load('devtools',version='2.4.2',repo='cran',load=F)
...
for(i in install_steps){
  ...
  check_install_load('GEOquery','2.56.0',repo='bioc',load=i)
  check_install_load('Biobase','2.48.0',repo='bioc',load=i)
  check_install_load('a4Base','1.36.0',repo='bioc',load=F)
  check_install_load('biomaRt','2.44.4',repo='bioc',load=i)
  check_install_load('oligo','1.52.1',repo='bioc',load=i)
  check_install_load('RSQLite','2.2.7',repo='bioc',load=i)
  check_install_load('DBI','1.1.1',repo='bioc',load=i)
  check_install_load('Rcpp','1.0.7',repo='bioc',load=i)
  check_install_load('pd.hugene.1.0.st.v1','3.14.1',repo='bioc',load=i)
  check_install_load('pd.hta.2.0','3.12.2',repo='bioc',load=i)
  check_install_load('pd.clariom.s.human','3.14.1',repo='bioc',load=i)
  check_install_load('limma','3.44.3',repo='bioc',load=i)
  check_install_load('illuminaio','0.30.0',repo='bioc',load=i)
  check_install_load('parallelDist','0.2.4',repo='bioc',load=i)
  check_install_load('WGCNA','1.70.3',repo='bioc',load=i)
  check_install_load('sva','3.36.0',repo='bioc',load=i)
  ...
  check_install_load('glmnet','4.1.2',repo='bioc',load=i)
  ...
  check_install_load('matrixStats','0.56.0',repo='bioc',load=i)
  ...
  check_install_load('STRINGdb','2.0.2',repo='bioc',load=i)
  check_install_load('ReactomePA','1.32.0',repo='bioc',load=i)
  check_install_load('org.Hs.eg.db','3.11.4',repo='bioc',load=i)
  check_install_load('rpart.plot','3.1.0',repo='bioc',load=i)
  check_install_load('knitr','1.37',repo='bioc',load=i)
